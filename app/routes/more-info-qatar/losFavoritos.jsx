      ...
      >
        <div className="col-md-6 px-0">
          <h1 className="display-4 fst-italic">
            Los favoritos para ganar el mundial
          </h1>
          <p className="lead my-3">
            En esta seccion se tratara sobre aquellas selecciones de alto nivel,
            que tienen mas probabilidades de ganar el mundial.
          </p>
